...
## Related Projects
Most of the build instructions in this project require that the 
"arm-sc-linux-gnueabi-" cross compiler suite generated by the 
**Seagate-Central-Toolchain** project be installed. See
