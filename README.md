...
This README file contains instructions common to all of the
utilities listed below. Read this file in conjunction with the
README-xxxxx.md instructions in the individual utility directories.
...
Some of the tools in this project assume that the target Seagate
...
* minidlna - Efficient replacement for the inbuilt TwonkyDLNA
* TODO : less, screen
